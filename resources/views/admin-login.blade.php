...
@include('partials.demo-notice')
    <main class="flex min-h-screen flex-col md:flex-row">
        <section class="relative flex h-[420px] w-full items-end overflow-hidden bg-black p-8 md:h-screen md:w-1/2 md:p-16 lg:w-3/5 lg:p-24">
            <div class="absolute inset-0"><img src="{{ asset('images/solea-admin-login-editorial.png') }}" alt="Soléa editorial fashion atelier" class="h-full w-full object-cover opacity-75"><div class="absolute inset-0 bg-gradient-to-t from-background via-background/25 to-transparent opacity-90"></div><div class="absolute inset-0 bg-gradient-to-r from-background/80 via-background/20 to-transparent opacity-70"></div></div>
